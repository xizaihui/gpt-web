...
<template>
  ...
  >
    ...
    <!-- Sidebar-specific -->
    <template v-else-if="name === 'pen-square'">
    ...
    <template v-else-if="name === 'more-vertical'">
      <circle cx="12" cy="5" r="2" fill="currentColor" stroke="none" /><circle cx="12" cy="12" r="2" fill="currentColor" stroke="none" /><circle cx="12" cy="19" r="2" fill="currentColor" stroke="none" />
    </template>
    <template v-else-if="name === 'pin'">
      <path d="M9 4v6l-2 4v2h10v-2l-2-4V4" /><line x1="12" y1="16" x2="12" y2="21" /><line x1="8" y1="4" x2="16" y2="4" />
    </template>
